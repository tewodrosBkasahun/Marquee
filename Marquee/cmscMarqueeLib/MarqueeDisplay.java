...
public class MarqueeDisplay extends JPanel implements Display {
	...
	public MarqueeDisplay() {
		this(ConfigValues.MARQUEE_WIDTH, ConfigValues.MARQUEE_HEIGHT);
	}

	public MarqueeDisplay(int displayAreaWidthInCells, int displayAreaHeightInCells) {
				...
				for (int row = 0; row < numRows; row++) {
					for (int col = 0; col < numCols; col++) {
						if (displayCells[row][col] != null) {
							...
							g.fill3DRect((int) (col * cellWidth), (int) (row * cellHeight), (int) (cellWidth),
									(int) (cellHeight), true);
						}
					}
				}
